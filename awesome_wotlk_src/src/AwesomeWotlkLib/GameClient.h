...
struct CharVectorEntry {
    CharData data;          // 0x188 bytes
    char extra[0x10];       // 16 bytes of additional fields, layout unknown
};
#pragma pack(pop)
static_assert(sizeof(CharVectorEntry) == 0x198, "struct CharVectorEntry corrupted");
