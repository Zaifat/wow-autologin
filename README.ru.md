...
- **Настройки клиента** — патч «4 ГБ», анти-АФК, пресеты графики на персонажа (тихий лёгкий режим для окон твинков)
- **2FA** — Google Authenticator, 2FAS, Яндекс.Ключ
- **Пароли зашифрованы** — ключом Windows или мастер-паролем для переносимого конфига
- **Инструменты** — пинг реалма, ярлыки на рабочий стол, ростер для форума гильдии, перенос настроек интерфейса между персонажами, бэкапы WTF
