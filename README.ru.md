...
- **Все персонажи на одном экране** — иконки расы и класса, золото, ГС, уровень, дейлики, арена за неделю, рейд-локауты, профессии
- **Поиск группы** — объявления о рейдах из чата по рейду, размеру, ролям и ГС; шепнуть в один клик (`/wm lfg`)
- **Общий список друзей и игнора** — редактируется в игре (`/wm friends`), любой персонаж можно исключить из синхронизации
- **Настройки клиента** — патч «4 ГБ» и свои пресеты графики
